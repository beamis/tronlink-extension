...
class BankDetailController extends React.Component {
    ...
    async getBankRecordDetail(_id) {
        ...
        const orderList = [
            { id: 'BANK.RENTDETAIL.RENTNUM', type: 0, value: `${recordDetail.freeze_amount / Math.pow(10, 6)}XLT` },
            { id: 'BANK.RENTDETAIL.RENTTIME', type: 2, value: recordDetail.days },
            { id: 'BANK.RENTDETAIL.PAYNUM', type: 0, value: `${recordDetail.pay_amount / Math.pow(10, 6)}XLT` },
        ...
        return (
            <div className='BankDetailContainer'>
                <NavBar
                    ...
                    onLeftClick={() => PopupAPI.changeState(APP_STATE.LITEBANK_RECORD)}
                >
