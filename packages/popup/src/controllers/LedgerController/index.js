...
class LedgerController extends React.Component {
    ...
    async onSubmit() {
        ...
        document.querySelector('#liteLedgerBridge').contentWindow.postMessage({target:"LEDGER-IFRAME",action:'connect ledger',data:''},'*');
    }
            ...
            <div className='insetContainer ledger'>
                ...
                <div className='greyModal scroll'>
                    ...
                    <div className="row">
                        ...
                        <img src={require('@litelink/popup/src/assets/images/new/ledger/step1.png')} alt=""/>
                    </div>
                    <div className="row">
                        ...
                        <img style={{height:22}} src={require('@litelink/popup/src/assets/images/new/ledger/step2_2.png')} alt=""/>
                    </div>
                    <div className="row">
                        ...
                        <img src={require('@litelink/popup/src/assets/images/new/ledger/step3.png')} alt=""/>
                    </div>
